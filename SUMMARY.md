    ...
    * [7. IoC容器](III.Core_Technologies/7.The_IoC_container.md)
        ...
        * [7.4 依赖](III.Core_Technologies/7.4.Dependencies.md)
            ...
            * [7.4.2 依赖和配置的细节](III.Core_Technologies/7.4.2.Dependencies_and_configuration_in_detail.md)
                ...
                * [idref元素](III.Core_Technologies/7.4.2.Dependencies_and_configuration_in_detail.md#idref元素)
                ...
                * [集合的合并](III.Core_Technologies/7.4.2.Dependencies_and_configuration_in_detail.md#集合的合并)
                * [集合合并的限制](III.Core_Technologies/7.4.2.Dependencies_and_configuration_in_detail.md#集合合并的限制)
                * [强类型集合](III.Core_Technologies/7.4.2.Dependencies_and_configuration_in_detail.md#强类型集合)
